...
# Module imports
from tracktor.utils.html_processor import strip_tags
from tracktor.db.mixins import SoftDeletionManager
from tracktor.utils.exception_logger import log_exception
from .project import ProjectBaseModel
from tracktor.utils.uuid import convert_uuid_to_integer
from .description import Description
from tracktor.db.mixins import ChangeTrackerMixin
...
class Issue(ProjectBaseModel):
    ...
    def save(self, *args, **kwargs):
        if self.state is None:
            try:
                from tracktor.db.models import State
