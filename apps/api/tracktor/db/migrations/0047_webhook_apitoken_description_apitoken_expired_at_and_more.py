...
import tracktor.db.models.api
import tracktor.db.models.webhook
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        validators=[
                            tracktor.db.models.webhook.validate_schema,
                            tracktor.db.models.webhook.validate_domain,
                        ]
                    ),
                ),
                ...
                (
                    "secret_key",
                    models.CharField(
                        default=tracktor.db.models.webhook.generate_token,
                        max_length=255,
                    ),
                ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                db_index=True,
                default=tracktor.db.models.api.generate_token,
                max_length=255,
                unique=True,
            ),
        ),
