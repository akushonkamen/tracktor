...
import tracktor.db.models.exporter
import tracktor.db.models.project
import uuid
import random
import string
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token",
                    models.CharField(
                        default=tracktor.db.models.exporter.generate_token,
                        max_length=255,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        default=tracktor.db.models.project.get_anchor,
                        max_length=255,
                        unique=True,
                    ),
                ),
                ...
                (
                    "views",
                    models.JSONField(
                        default=tracktor.db.models.project.get_default_views
                    ),
                ),
                (
                    "created_by",
