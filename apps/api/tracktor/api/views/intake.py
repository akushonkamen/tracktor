...
from tracktor.app.permissions import ProjectLitePermission
from tracktor.bgtasks.issue_activities_task import issue_activity
from tracktor.db.models import Intake, IntakeIssue, Issue, Project, ProjectMember, State, StateGroup
