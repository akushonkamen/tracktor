...
const APP_TITLE = "Tracktor | Simple, extensible, open-source project management tool.";
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:image:alt", content: "Tracktor - Modern project management" },
  {
    name: "keywords",
    content:
  ...
  { name: "twitter:image:alt", content: "Tracktor - Modern project management" },
];
