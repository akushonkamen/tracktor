...
const APP_TITLE = "Tracktor Publish | Make your Tracktor boards public with one-click";
const APP_DESCRIPTION = "Tracktor Publish is a customer feedback management tool built on top of tracktor.so";
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:url", content: "https://sites.tracktor.so/" },
  {
    name: "keywords",
    content:
