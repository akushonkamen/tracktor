...
export default {
  ...
  support: "Поддержка",
  forum: "Forum",
  powered_by_plane_pages: "Работает на Tracktor Pages",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Скопируйте и сохраните секретный ключ в Tracktor Pages. После закрытия ключ будет недоступен. CSV-файл с ключом был скачан.",
