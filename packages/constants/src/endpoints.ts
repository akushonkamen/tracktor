...
// tracktor website url
export const WEBSITE_URL = process.env.VITE_WEBSITE_URL || "https://tracktor.so";
// support email
export const SUPPORT_EMAIL = process.env.VITE_SUPPORT_EMAIL || "support@tracktor.so";
// marketing links
export const MARKETING_PRICING_PAGE_LINK = "https://tracktor.so/pricing";
export const MARKETING_CONTACT_US_PAGE_LINK = "https://tracktor.so/contact";
export const MARKETING_PLANE_ONE_PAGE_LINK = "https://tracktor.so/one";
