...
import type { IState, TFilterProperty, TStateGroups, TSupportedOperators } from "@tracktor/types";
import { COLLECTION_OPERATOR, EQUALITY_OPERATOR } from "@tracktor/types";
// local imports
